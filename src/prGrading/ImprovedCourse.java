...
public class ImprovedCourse {

        private String name;
        private Student[] studentsData;
        private String[] errors;

        public ImprovedCourse(String name, String[] studentsData) {
            this.name = name;
            Scanner sc;
            int i = 0;
            int errorIndex = 0;
        ...
        public double getAverage(MeanCalculation m) throws StudentException {
            return  m.calculate(getStudents());
        }
